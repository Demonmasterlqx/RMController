...
enum class WorkMode
{
  POSITION_SINE_SPEED_FIXED,    // 模式1: 位置正弦波，速度固定
  SPEED_SINE_POSITION_FIXED,    // 模式2: 速度正弦波，位置固定
  POSITION_SINE_SPEED_DERIVED   // 模式3: 位置正弦波，速度求导
};
...
private:
   ...
   * @return 正弦波速度值
   */
  double calculate_sine_speed(double time_sec);
